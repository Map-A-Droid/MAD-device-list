...
| [A95X F1 (2GB/16GB)](https://www.amazon.de/gp/product/B07DCL3YPZ/) | S905W | [MAD rom](https://github.com/Map-A-Droid/MAD-ATV/releases) | 18.1 | Yes | USB A to USB A | ~20 min. | Readme file in the ATV repository |
...
**Important note about the x96 mini:** There are fakes out there that are not flashable!
